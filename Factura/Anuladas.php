        ...
        <div class="row">
          <div class="col-lg-11 col-md-11 caja">
            <div class="card-deck">
              <div class="card mb-4 hoverable p-2">
                <div class="view overlay">
                  ...
                  <form name="form" action="Servicios.php" method="post" enctype="multipart/form-data">
                    ...
                    <table id="dt-bordered" class="table table-bordered" cellspacing="0" width="100%" align="center">
                      ...
                      $consulta="SELECT * FROM factura WHERE FacturaAnulada=1 order by Id desc LIMIT $empieza, $por_pagina";
                      ...
                      while($Fila=mysqli_fetch_assoc($ejecutar)){
                        ...
                        <tbody id="myTable">
                          ...
                          <td>
                           <center>
                             <a href="../pdf/anulada.php?PDF=<?php echo $id;?>" class="btn btn-outline-primary waves-effect" name="Generar" target="_blank"><i class="far fa-file-pdf"></i></center></a>
                           </center>
                         </td> 
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination pg-blue paginacion">
                    ...
                    echo "<center><li class=\"page-item paginacion\"><a href='Anuladas.php?pagina=1' class=\"page-link paginacion\">".'Primera '."</a></i>";

                    for ($i=1; $i <=$total_paginas ; $i++) { 
                      echo "<li class=\"page-item paginacion\"><a href='Anuladas.php?pagina=".$i."' class=\"page-link paginacion\">".$i."</a></i>";
                    }

                    echo "<li class=\"page-item paginacion\"><a href='Anuladas.php?pagina=$total_paginas' class=\"page-link paginacion\">".'Última '."</a></i></center>";
                    ?>
                  </ul>
                </nav>
              ...
              <a href="FacturasGuardadas.php" name="anuladas" class="btn btn-outline-success waves-effect" value="" style="float: left !important;"><b> Volver </b> </a>
