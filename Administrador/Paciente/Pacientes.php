            ...
            <div class="card-header py-3">
              <div class="row mb-4">
                <div class="col-md-6 text-md-start text-center">
                  <h5 class="fw-bold EstiloLetraTarjeta">Pacientes</h4>
                    <small class="text-muted">Gestión de pacientes</small>
                </div>
                <div class="col-md-6 text-md-end text-center">
                  <a href="crear_paciente.php" class="btn btn-primary">
                    + Nuevo paciente
                  </a>
                </div>
              </div>
                      ...
                      <?php while ($row = mysqli_fetch_assoc($resultado)): ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="ver_paciente.php?id=<?= $row['Id']; ?>" class="btn btn-sm btn-outline-info">
                              <i class="fa fa-eye"></i>
                            </a>

                            <?php if ($row['Estado'] == 1): ?>
                              <a href="editar_paciente.php?id=<?= $row['Id']; ?>" class="btn btn-sm btn-outline-warning">
                                <i class="fa fa-pen"></i>
                              </a>
                              <a href="cambiar_estado_paciente.php?id=<?= $row['Id']; ?>&estado=0"
                                class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Desactivar este paciente?');">
                                <i class="fa fa-ban"></i>
                              </a>
                            <?php else: ?>
                              <a href="cambiar_estado_paciente.php?id=<?= $row['Id']; ?>&estado=1"
                                class="btn btn-sm btn-outline-success" onclick="return confirm('¿Activar este paciente?');">
