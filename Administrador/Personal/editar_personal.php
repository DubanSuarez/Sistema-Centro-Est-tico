                        ...
                        <div class="card-header py-3">
                            <div class="row mb-4">
                                <div class="col-md-6 text-md-start text-center">
                                    <h5 class="fw-bold EstiloLetraTarjeta">Editar contrato</h5>
                                    <small class="text-muted">
                                        Actualización de información contractual y personal
                                    </small>
                                </div>
                            </div>
                        </div>
...
// ===============================
  ...
  SELECT * FROM contratopersona WHERE Id = $idContrato
");
...
// ===============================
                            ...
                            <form action="actualizar_contrato.php" method="POST">
                                <input type="hidden" name="IdContrato" value="<?= $data['Id'] ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="Rol" class="form-select" required>
                                            <?php while ($r = mysqli_fetch_assoc($roles)) { ?>
                                                <option value="<?= $r['Nombre'] ?>" <?= ($data['Rol'] == $r['Nombre']) ? 'selected' : '' ?>>
                                                    <?= $r['Nombre'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="NumeroDocumento" class="form-control"
                                            value="<?= $data['NumeroDocumento'] ?>" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="Genero" class="form-select" required>
                                            <?php
                                            $generos = ['Femenino', 'Masculino', 'No binario', 'Prefiere no decirlo'];
                                            foreach ($generos as $g) {
                                                echo "<option value='$g' " . ($data['Genero'] == $g ? 'selected' : '') . ">$g</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="date" name="FechaContrato" class="form-control"
                                            value="<?= $data['FechaContrato'] ?>" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="FormaPago" class="form-select" required>
                                            <?php
                                            $pagos = ['Efectivo', 'Transferencia', 'Consignación', 'Mixto'];
                                            foreach ($pagos as $p) {
                                                echo "<option value='$p' " . ($data['FormaPago'] == $p ? 'selected' : '') . ">$p</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="Especialidad" class="form-select">
                                            ...
                                            foreach ($esp as $e) {
                                                echo "<option value='$e' " . ($data['Especialidad'] == $e ? 'selected' : '') . ">$e</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="EstadoCivil" class="form-select">
                                            <?php
                                            $estados = ['Soltero(a)', 'Casado(a)', 'Unión libre', 'Separado(a)', 'Divorciado(a)', 'Viudo(a)'];
                                            foreach ($estados as $e) {
                                                echo "<option value='$e' " . ($data['EstadoCivil'] == $e ? 'selected' : '') . ">$e</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
