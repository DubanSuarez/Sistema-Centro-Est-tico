                            ...
                            <div class="row mb-4">
                                <div class="row mb-4">
                                    <div class="col-md-6 text-md-start text-center">
                                        <h5 class="fw-bold EstiloLetraTarjeta">Reporte de Ingresos</h5>
                                        <small class="text-muted">Control y análisis de facturación del centro
                                            estético</small>
                                    </div>
                                </div>
...
";
                            ...
                            /* ================== TOTAL INGRESOS ================== */
                            $sql_ingresos = "
SELECT SUM(f.Total) AS ingresos
FROM factura f
$whereSQL
";
                            $res_ingresos = mysqli_query($conexion, $sql_ingresos);
                            $total_ingresos = mysqli_fetch_assoc($res_ingresos)['ingresos'] ?? 0;
                            ?>
                            ...
                            <div class="alert alert-success fw-bold">
                                💰 Total de ingresos: $<?= number_format($total_ingresos, 0) ?>
                            </div>
                                        ...
                                        <?php if (mysqli_num_rows($resultado) > 0): ?>
                                            <?php while ($row = mysqli_fetch_assoc($resultado)): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= date('Y-m-d H:i', strtotime($row['FechaHora'])) ?></td>
                                                    <td><?= $row['Paciente'] ?></td>
