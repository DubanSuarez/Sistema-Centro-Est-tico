			...
			<section class="mb-4">
				<div class="card">
					<div class="card-header py-3">
						...
						<div class="card-header py-3">
							<div class="row gap-2">
								<div class="col-md-6 d-flex justify-content-md-start justify-content-center">
									<h5 class=" mb-0 text-center EstiloLetraTarjeta">Editar publicación</h5>
						...
						$sql = "SELECT * FROM blog WHERE Id = $idPublicacion";
						...
						<form action="update_publicacion.php" method="POST" enctype="multipart/form-data">
							...
							<div class="mb-3">
								...
								<textarea name="resumen" class="form-control" rows="2"
									required><?= htmlspecialchars($row['Resumen']) ?></textarea>
							</div>
							...
							<div class="mb-3">
								...
								<textarea name="comentario" class="form-control" rows="4"
									required><?= htmlspecialchars($row['Comentario']) ?></textarea>
							</div>
							...
							<div class="mb-3">
								...
								<select name="tipo" class="form-select">
									<option value="NOTICIA" <?= $row['Tipo'] == 'NOTICIA' ? 'selected' : '' ?>>Noticia
									</option>
									<option value="OFERTA" <?= $row['Tipo'] == 'OFERTA' ? 'selected' : '' ?>>Oferta
									</option>
									<option value="DESCUENTO" <?= $row['Tipo'] == 'DESCUENTO' ? 'selected' : '' ?>>
										Descuento</option>
								</select>
							</div>
							...
							<div class="form-check mb-2">
								<input class="form-check-input" type="checkbox" name="destacado" <?= $row['Destacado'] ? 'checked' : '' ?>>
							...
							<div class="d-flex justify-content-between mt-5 mb-5">
								...
								<a href="InicioAdministrador.php" class="btn btn-outline-success btn-rounded"
									data-mdb-ripple-init data-mdb-ripple-color="dark">
									Cancelar
								</a>
								<button type="submit" class="btn btn-outline-warning btn-rounded" data-mdb-ripple-init
									data-mdb-ripple-color="dark">
									<i class="fa-solid fa-save"></i> Actualizar publicación
								</button>
							</div>
